...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'etrax.png')) {
		$tcpdf_header_logo = 'etrax.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'e-Trax');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'e-Trax');
}
...
if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Nicolaus Piso & Philipp Toscani\nwww.etrax.at");
}
...
if (!defined('PDF_IMAGE_SCALE_RATIO')) {
	define ('PDF_IMAGE_SCALE_RATIO', 0.5);
}
